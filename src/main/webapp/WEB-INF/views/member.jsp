...
<div class="w3-display-middle" style="width:50%;height:50%;margin-top:8%">
    <form class="form-horizontal" method="post" action="editPassword.jsp">
  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10" style="padding-left:30%">
      <a href="memberEdit.jsp" class="btn btn-default" role="button" type="submit">編輯</a>
