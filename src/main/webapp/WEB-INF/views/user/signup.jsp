...
<div class="w3-display-middle" style="width:50%;height:50%;margin-top:8%">
    <form class="form-horizontal" method="post" action="successSign.jsp">
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label"><i class="fa fa-key"></i> 密碼</label>
    <div class="col-sm-10">
      <input type="password" class="form-control" id="inputPassword3" placeholder="Password" name="sign-password">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label"><i class="fa fa-address-card"></i> 地址</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Address" name="sign-address" maxlength="40">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label"><i class="fa fa-birthday-cake"></i> 生日</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Birthday" name="sign-birth">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label"><i class="fa fa-credit-card"></i> 信用卡號</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Credit Card Number" name="sign-credit" maxlength="16">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label"><i class="fa fa-phone"></i> 電話</label>
    <div class="col-sm-10">
      <input type="tel" class="form-control" id="inputPassword3" placeholder="Telephone Number" name="sign-tel">
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
