...
<body data-spy="scroll" data-target="#myScrollspy" data-offset="15">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <br>
            <br>
            <form class="form-horizontal" style="align:left">
                <div class="form-group">
                  <label class="control-label col-sm-2" >出貨單編號：</label>
                  <div class="col-sm-10">
                    <input type="hidden" class="form-control" value="11111" name="ship-id"><h4>123456</h4>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2">客戶名稱：</label>
                  <div class="col-sm-10">          
                    <h4>Sypher</h4>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="pwd">出貨狀況：</label>
                  <div class="col-sm-10">          
                    <h4 style="color:red">已出貨</h4>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="pwd">出貨人員：</label>
                  <div class="col-sm-10">          
                    <h4>Mark Otto</h4>
                  </div>
                </div>
