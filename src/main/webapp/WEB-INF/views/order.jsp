...
<div class="w3-display-topmiddle w3-container w3-padding-4 w3-center w3-xxlarge" style="width:50%;margin-top:8%">
  ...
  <div class=" w3-display-topmiddle" style="width:75%;margin-top:15%;margin-bottom:5%">
  <table class="w3-table-all">
    ...
    <tr>
      <td><a href="orderDetail.jsp">222222</a></td>
      <td>500元</td>
      <td>2016/11/22</td>
      <td>確認中</td>
      <td>已付款</td>
    ...
    <tr>
      <td><a href="orderDetail.jsp">333333</a></td>
      <td>6000元</td>
      <td>2016/11/23</td>
      <td>待付款</td>
      <td>未付款</td>    
