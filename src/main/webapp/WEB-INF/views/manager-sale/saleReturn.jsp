<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
    ...
    <body>
        <%@include file="nav.jspf" %>
            <div class="w3-display-topmiddle w3-container w3-padding-4 w3-center w3-xxlarge" style="width:50%;margin-top:5%;margin-left:10%"> 退貨單細項 </div>
            <div class="w3-display-middle" style="width:50%;height:50%;margin-top:0%;margin-left:10%">
                <form class="form-horizontal" method="post" action="index.jsp">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="font-size:20px"> 29000元 </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label"> 換貨原因：</label>
                        <div class="col-sm-10" style="font-size:20px"> 就是想換 </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="true" name="ship-confirm"> 確認退貨</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
