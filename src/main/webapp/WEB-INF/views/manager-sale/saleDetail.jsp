<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
    ...
    <body>
        <%@include file="nav.jspf" %>
            <div class="w3-display-topmiddle w3-container w3-padding-4 w3-center w3-xxlarge" style="width:50%;margin-top:5%;margin-left:10%"> 確認訂單 </div>
            <div class="w3-display-topmiddle" style="width:50%;height:50%;margin-top:10%;margin-left:10%">
                <form class="form-horizontal" method="post" action="index.jsp">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="font-size:20px;color:red"> 未付款 </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="true" name="ship-confirm"> 確認訂單</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-primary" name="ship-ship-submit">建立</button>
                        </div>
                    </div>
                </form>
            </div>
